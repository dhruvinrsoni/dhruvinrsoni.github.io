...
**🧠 [Smruti Cortex](https://github.com/dhruvinrsoni/smruti-cortex)** — *Chrome Extension*
Ultra-fast browser history search with optional local AI via Ollama.
[Web Store](https://chromewebstore.google.com/detail/ecnkiihcifbfnhjblicfbppplobiicoi) · [Live](https://dhruvinrsoni.github.io/smruti-cortex/quality-report/) · [Repo](https://github.com/dhruvinrsoni/smruti-cortex)

**💬 [Samvada Studio](https://github.com/dhruvinrsoni/samvada-studio)** — *Web App / PWA*
Multi-provider LLM chat UI — OpenAI, Anthropic, Google, Ollama, Azure.
[Live](https://dhruvinrsoni.github.io/samvada-studio/) · [Product Hunt](https://www.producthunt.com/products/samvada-studio) · [Repo](https://github.com/dhruvinrsoni/samvada-studio)

**🔐 [Cipher Alchemist](https://github.com/dhruvinrsoni/cipher-alchemist)** — *PWA*
Secure, offline-capable phrase-to-password generator with custom rules.
[Live](https://dhruvinrsoni.github.io/cipher-alchemist/) · [Repo](https://github.com/dhruvinrsoni/cipher-alchemist)

### Web Apps & PWAs

**📓 [Smart Logger](https://github.com/dhruvinrsoni/smart-logger)** — *PWA*
Privacy-first offline logger with dual UI (modern + classic), CSV/JSON export.
[Live](https://dhruvinrsoni.github.io/smart-logger/) · [Repo](https://github.com/dhruvinrsoni/smart-logger)

**🌱 [Ankura Array](https://github.com/dhruvinrsoni/ankura-array)** — *Nano-apps Hub*
Offline-first nano-apps incubator — Vaak-Smith and GenAI-Yukti-Deck inside.
[Live](https://dhruvinrsoni.github.io/ankura-array/) · [Repo](https://github.com/dhruvinrsoni/ankura-array)

**🍕 [Pizza Ordering System](https://github.com/dhruvinrsoni/online-pizza-ordering-system)** — *Web App*
